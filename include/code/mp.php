...
<div class="w960 center clear mt1">
	<div class="pleft">
		<div class="place">
			<strong>:</strong>£º<a href="{dede:global.cfg_cmsurl/}/"></a> &gt; <a href='tags.php'></a> &gt; {dede:field.title /}
		</div><!-- /place -->
		<div class="listbox">
			<ul class="e2">
{dede:list orderby='sortrank' pagesize='10'}
				<li>
					...
					<span class="info">
						<small>£º</small>[field:pubdate function="GetDateTimeMK(@me)"/]
						<small>£º</small>[field:click/]
						<small>£º</small>[field:scores/]
					</span>
					<p class="intro">
						[field:description/]...
					</p>
