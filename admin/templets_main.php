...
if($acdir=="member"){
	$templetdir = $cfg_basedir.$cfg_member_dir;
	$templetdird = $cfg_basedir.$cfg_member_dir."/templets/";
	$templeturld = $cfg_member_dir."/templets/";
}else{
...
$fileinfos = ($acdir=='member' ? $pluslists : $filelists);
