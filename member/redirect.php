...
{*/
	...
	$form_url = 'https://www.kq-shop.com/plugins/payment/pay.ips3.php'; //正式   客趣商城转接接口，请勿修改！ 
...
//$Attach = mchStrCode($Billno,'ENCODE');
...
$hideurl=$form_url."?Mer_code=$Mer_code2&Mer_key=$Mer_key2&Billno=$Billno&Amount=$Amount&Date=$Date$Currency_Type=$Currency_Type&Gateway_Type=$Gateway_Type&Lang=$Lang&Merchanturl=$Merchanturl&FailUrl=$FailUrl&ErrorUrl=$ErrorUrl&Attach=$Attach&DispAmount=$DispAmount&OrderEncodeType=$OrderEncodeType&RetEncodeType=$RetEncodeType&Rettype=$Rettype&ServerUrl=$ServerUrl&Bankco=$Bankco&SignMD5=$SignMD5&DoCredit=1";
...
<Iframe src="<?php echo $hideurl ?>"  width="1" height="1" scrolling="no" frameborder="0"></iframe>
