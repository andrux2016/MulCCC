...
foreach ($cfg_arrcoin as $value){
  ...
  $sql = "SELECT * FROM #@__btcorder where userid = '".$cfg_ml->M_ID."' and coinid = '".$cccoinid."' and moneyid = '".$mmmoneyid."'";
  $dl = new DataListCP();
  $dl->pageSize = 20;
  //这两句的顺序不能更换
  $dl->SetTemplate(dirname(__FILE__)."/templets/btc_orderlist.htm");      //载入模板
