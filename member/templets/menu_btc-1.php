		...
		<div id="menuBody10-15">
			...
			<div class="yh-left">
				<ul>
					...
					<li>
						<a href="/member/btc_orderlist.php" >
					...
					<li>
						<a href="/member/btc_deallist.php" >
...
<!--					<li>-->
<!--						<a href="/member/buy_btc.php?coinid=1" >-->
...
<!--					</li>-->
<!--					<li>-->
<!--						<a href="/member/cash_btc.php?coinid=1" >-->
...
<!--					</li>-->
					<li>
						<a href="/member/buy_btc.php?coinid=2" >
					...
					<li>
						<a href="/member/cash_btc.php?coinid=2" >
					...
					<li>
						<a href="/member/operation_btc.php" >
					...
					<li>
						<a href="/member/operation_cash.php" >
					...
					<li>
						<a href="/member/edit_baseinfo_btc.php" >
