 ...
 * 我的收藏夹
 * 
 * @version        $Id: myfriend_group_btc.php 1 8:38 2010年7月9日Z SZ $
 */
...
if($dopost == '')
{
    ...
    $tpl->LoadTemplate(DEDEMEMBER.'/templets/myfriend_group_btc.htm');
    $tpl->Display();
    exit();
}
elseif ($dopost == 'add')
{   
    ...
    {
        ShowMsg('增加分类成功', 'myfriend_group_btc.php');
    }
    else
    {
        ShowMsg('增加分类失败', '-1');
    ...
    ShowMsg('分组修改完成(删除分组中的会员会转移到默认分组中)','myfriend_group_btc.php');
    exit();
}