	...
	var main_ask_bid_list_obj = {
		...
		reload_ask_bid_grid: function() {
			...
			for (var i = 0; i < ask_length; i++){
				...
				$(".l_divAskList").append("<tr><td style='color:#FF0000'>卖("+(i+1)+")</td><td>"+ this.ask_list[i].rate.toFixed(4) +"</td><td>"+this.ask_list[i].symbol_l.toFixed(4)+"</td></tr>");
				
				if(i<5) $("#l_divList").prepend("<tr><td style='color:#FF0000'>卖("+(i+1)+")</td><td>"+ this.ask_list[i].rate.toFixed(4) +"</td><td>"+this.ask_list[i].symbol_l.toFixed(4)+"</td></tr>");
				//if(i<5) $("#l_divList").prepend("<tr><td style='color:#990000'>卖("+(i+1)+")</td><td>"+ this.ask_list[i].rate.toFixed(4) +"</td><td>"+this.ask_list[i].symbol_l.toFixed(4)+"</td><td title='"+ this.ask_list[i].count + "单'><div style='background-color:#990000;height:20px;width:"+(this.ask_list[i].symbol_r/mastcount*100)+"%'></div></td></tr>");
			}
			...
			for (var i = 0; i < bid_length; i++){
				...
				$(".l_divBidList").append("<tr><td style='color:#009900'>买("+(i+1)+")</td><td>"+ this.bid_list[i].rate.toFixed(4) +"</td><td>"+this.bid_list[i].symbol_l.toFixed(4)+"</td></tr>");
				
				if(i<5) $("#l_divList").append("<tr><td style='color:#009900'>买("+(i+1)+")</td><td>"+ this.bid_list[i].rate.toFixed(4) +"</td><td>"+this.bid_list[i].symbol_l.toFixed(4)+"</td></tr>");
				//if(i<5) $("#l_divList").append("<tr><td style='color:#009900'>买("+(i+1)+")</td><td>"+ this.bid_list[i].rate.toFixed(4) +"</td><td>"+this.bid_list[i].symbol_l.toFixed(4)+"</td><td title='"+ this.bid_list[i].count + "单'><div style='background-color:#009900;height:20px;width:"+(this.bid_list[i].symbol_r/mastcount*100)+"%'></div></td></tr>");
			}
	...
	var main_history_grid_obj = {
		...
		init: function(history_data) {
			...
			for (var i = 0; i < this.history_data.length; i++){
				...
				$(".hqHistoryList").append("<tr><td>"+this.history_data[i].order+"</td><td>"+ stime +"</td><td>"+(this.history_data[i].rate.toFixed(4))+"</td><td>"+(this.history_data[i].amount_l.toFixed(4))+"</td></tr>");
