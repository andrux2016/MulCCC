	...
	var main_ask_bid_list_obj = {
		...
		reload_ask_bid_grid: function() {
			...
			for (var i = 0; i < ask_length; i++){
				...
				$(".l_divAskList").append("<tr><td class='sell'>卖("+(i+1)+")</td><td>￥"+ this.ask_list[i].rate.toFixed(2) +"</td><td>"+this.ask_list[i].symbol_l.toFixed(8)+"</td><td title='"+ this.ask_list[i].count + "单'><span  class='buySpan' style='width:"+(this.ask_list[i].symbol_r/mastcount*100)+"%'></span></td></tr>");
				if(i<5) $(".l_divList").prepend("<tr><td class='sell'>卖("+(i+1)+")</td><td>￥"+ this.ask_list[i].rate.toFixed(2) +"</td><td>"+this.ask_list[i].symbol_l.toFixed(8)+"</td><td title='"+ this.ask_list[i].count + "单'><span  class='buySpan' style='width:"+(this.ask_list[i].symbol_r/mastcount*100)+"%'></span></td></tr>");
			...
			for (var i = 0; i < 5; i++){				
				$(".l1_divAskList").append("<tr><td class='sell'><font color='#008020'>卖("+(i+1)+")</font></td><td>￥"+ this.ask_list[i].rate.toFixed(2) +"</td><td>฿"+this.ask_list[i].symbol_l.toFixed(8)+"</td></tr>");
			...
			for (var i = 0; i < 5; i++){
				/*jQuery("#tableBidList").jqGrid('addRowData', i + 1, this.bid_list[i]);*/
				$(".l1_divBidList").append("<tr><td class='buy'><font color='#00aeae'>买("+(i+1)+")</font></td><td>￥"+ this.bid_list[i].rate.toFixed(2) +"</td><td>฿"+this.bid_list[i].symbol_l.toFixed(8)+"</td></tr>");
